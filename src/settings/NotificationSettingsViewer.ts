...
import stream from "mithril/stream"
import { PushIdentifier, PushIdentifierTypeRef, User } from "../api/entities/sys/TypeRefs.js"
...
export class NotificationSettingsViewer implements UpdatableSettingsViewer {
			...
			m(".flex.col", [
				...
				[
					...
					m(".flex-space-between.items-center.mt-s.mb-s", [
						m(".h5", lang.get("notificationSettings_placeholder")),
						m(ExpanderButton, {
							label: "show_action",
	...
	private renderExtendedNotificationPref(): Children {
		return this.extendedNotificationMode == null
			? null
			: m(DropDownSelector, {
					label: "extendedNotification_label",
					items: [
						{
							name: lang.get("noSenderOrSubject_action"),
							value: ExtendedNotificationMode.NoSenderOrSubject,
						},
						{
							name: lang.get("onlySender_action"),
							value: ExtendedNotificationMode.OnlySender,
						},
						{
							name: lang.get("senderAndSubject_action"),
